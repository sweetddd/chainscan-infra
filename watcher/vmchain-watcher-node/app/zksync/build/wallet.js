...
class Wallet {
  ...
  emergencyWithdraw(withdraw) {
    return __awaiter(this, void 0, void 0, function* () {
      const gasPrice = yield this.ethSigner.provider.getGasPrice();
      const accountId = withdraw.accountId != null ? withdraw.accountId : yield this.resolveAccountId();
      const mainZkSyncContract = this.getZkSyncMainContract();
  ...
  emergencyWithdrawNFT(withdrawNFT) {
    return __awaiter(this, void 0, void 0, function* () {
      const gasPrice = yield this.ethSigner.provider.getGasPrice();
      const accountId = withdrawNFT.accountId != null ? withdrawNFT.accountId : yield this.resolveAccountId();
      const mainZkSyncContract = this.getZkSyncMainContract();
      try {
