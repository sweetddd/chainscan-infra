...
function getCREATE2AddressAndSalt(syncPubkeyHash, create2Data) {
  ...
  const address = '0x' +
        ethers_1.ethers.utils
          ...
          .slice(2 + 12 * 2);
  return { address, salt: ethers_1.ethers.utils.hexlify(salt) };
}
...
function getEthereumBalance(ethProvider, syncProvider, address, token) {
  return __awaiter(this, void 0, void 0, function* () {
    let balance;
    const tokenAdrress = syncProvider.tokenSet.resolveTokenAddress(token);
    if (isTokenETH(tokenAdrress)) {
...
function getTxHash(tx) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const txBytes = yield serializeTx(tx);
