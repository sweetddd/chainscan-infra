...
export declare function getDefaultRestProvider(network: types.Network): Promise<RestProvider>;
...
export declare class RestProvider extends SyncProvider {
    ...
    accountTxsDetailed(idOrAddress: number | types.Address, paginationQuery: types.PaginationQuery<string>): Promise<Response<types.Paginated<types.ApiTransaction, string>>>;
    accountTxs(idOrAddress: number | types.Address, paginationQuery: types.PaginationQuery<string>): Promise<types.Paginated<types.ApiTransaction, string>>;
    ...
    tokenByIdOrAddressDetailed(idOrAddress: number | types.TokenAddress): Promise<Response<types.TokenInfo>>;
    tokenByIdOrAddress(idOrAddress: number | types.TokenAddress): Promise<types.TokenInfo>;
    tokenPriceInfoDetailed(idOrAddress: number | types.TokenAddress, tokenIdOrUsd: number | 'usd'): Promise<Response<types.TokenPriceInfo>>;
    tokenPriceInfo(idOrAddress: number | types.TokenAddress, tokenIdOrUsd: number | 'usd'): Promise<types.TokenPriceInfo>;
    ...
    getTokens(limit?: number): Promise<types.Tokens>;
    getState(address: types.Address): Promise<types.AccountStateRest>;
