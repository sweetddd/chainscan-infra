...
const Bridge = require('./contracts/Bridge.json');
const Erc20Handler = require('./contracts/ERC20Handler.json');
const GenericHandler = require('./contracts/GenericHandler.json');
